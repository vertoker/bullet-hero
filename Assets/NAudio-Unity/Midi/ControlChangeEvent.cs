    ...
    public class ControlChangeEvent : MidiEvent 
    {
        ...
        public ControlChangeEvent(BinaryReader br) 
        {
            ...
            if((c & 0x80) != 0) 
            {
                ...
                throw new System.IO.InvalidDataException("Invalid controller");
            }
            controller = (MidiController) c;
            if((controllerValue & 0x80) != 0) 
            {
                throw new System.IO.InvalidDataException(String.Format("Invalid controllerValue {0} for controller {1}, Pos 0x{2:X}", controllerValue, controller, br.BaseStream.Position));
            }
        }
