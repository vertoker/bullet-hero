            ...
            while (stream.Position <= stopPosition - 8)
            {
                ...
                else if (chunkIdentifier == formatChunkId)
                {
                    if (chunkLength > Int32.MaxValue)
                         throw new System.IO.InvalidDataException(string.Format("Format chunk length must be between 0 and {0}.", Int32.MaxValue));
                ...
                else
                {
                    ...
                    {
                        if (chunkLength > Int32.MaxValue)
                            throw new System.IO.InvalidDataException(string.Format("RiffChunk chunk length must be between 0 and {0}.", Int32.MaxValue));
